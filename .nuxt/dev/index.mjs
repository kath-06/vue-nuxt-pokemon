...
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://C:/Users/user/Documents/vue-nuxt-pokemon/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://C:/Users/user/Documents/vue-nuxt-pokemon/node_modules/devalue/index.js';
import { renderToString } from 'file://C:/Users/user/Documents/vue-nuxt-pokemon/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file://C:/Users/user/Documents/vue-nuxt-pokemon/node_modules/@unhead/ssr/dist/index.mjs';
...
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file://C:/Users/user/Documents/vue-nuxt-pokemon/node_modules/ufo/dist/index.mjs';
...
import { version, unref } from 'file://C:/Users/user/Documents/vue-nuxt-pokemon/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file://C:/Users/user/Documents/vue-nuxt-pokemon/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://C:/Users/user/Documents/vue-nuxt-pokemon/node_modules/@unhead/shared/dist/index.mjs';
...
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\Users\\user\\Documents\\vue-nuxt-pokemon\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _df2wkbqVVI = (function(nitro) {
...
const _lazy_kQwXDw = () => Promise.resolve().then(function () { return pokemon$1; });
const _lazy_icFz0A = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/pokemon', handler: _lazy_kQwXDw, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_icFz0A, lazy: true, middleware: false, method: undefined },
...
const getPokemonList = async (event) => {
  const { limit, offset } = getQuery$1(event);
...
const pokemon$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: pokemon
});
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"Vue 3, Nuxt 3 and Tailwind"}],"link":[{"rel":"stylesheet","href":"https://fonts.googleapis.com/icon?family=Material+Icons"}],"style":[],"script":[],"noscript":[],"title":"Vue-Nuxt Pokemon"};
...
const getClientManifest = () => import('file://C:/Users/user/Documents/vue-nuxt-pokemon/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://C:/Users/user/Documents/vue-nuxt-pokemon/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
